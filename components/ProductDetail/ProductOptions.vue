...
<script>
const ProductOptionColourSelector = () => import('~/components/ProductDetail/ProductOptionsColourSelector');
const ProductOptionSelect = () => import('~/components/ProductDetail/ProductOptionsSelect');
